...
# Creates a function 'add' that takes two arguments, prints them in a formatted string, and returns the arguments added together. 
def add(a,b):
	print(f"ADDING {a} + {b}")
	return a + b

# Creates a function 'subtract' that takes two arguments, prints them in a formatted string, and returns the arguments and subtracts one from the other. 
def subtract(a,b):
	print(f"SUBTRACTING {a} - {b}")
	return a - b

# Creates a function 'multiply' that takes two arguments, prints them in a formatted string, and returns the arguments multiplied by each other. 
def multiply(a,b):
	print(f"MULTIPLYING {a} * {b}")
	return a * b

# Creates a function 'divide' that takes two arguments, prints them in a formatted string, and returns the arguments, one divided by the other. 
def divide(a,b):
...
age = add(30,5) # Creates a variable 'age' and assigns it the value of the function add with the values 30 and 5 passed in
height = subtract(78,4) # Creates a variable 'height' and assigns it the value of the function subtract with the values 78 and 4 passed in
weight = multiply(90,2) # Creates a variable 'weight' and assigns it the value of the function multiply with the values 90 and 2 passed in
iq = divide(100,2) # Creates a variable 'iq' and assigns it the value of the function divide with the values 100 and 2 passed in

print(f"Age: {age}, Height: {height}, Weight: {weight}, IQ: {iq}") # Prints a formatted string that includes the variables age, height, weight, & iq

print("Here is a puzzle.") # Prints a string

what = add(age, subtract(height, multiply(weight, divide(iq, 2)))) # Creates a variable and assigns it the value of divide, within multiply, within subtract, within add functions

print("That become: ", what, "Can you do it by hand?") # Prints a string with the variable 'what' included